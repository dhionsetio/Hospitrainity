...
@section('content')
    ...
    <div class="flex min-h-screen flex-col bg-neutral-100 md:h-screen md:flex-row">
        ...
        <main class="min-w-0 flex-1 p-6 md:overflow-y-auto md:p-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-neutral-500">{{ __('admin.active_canonical_chapters') }}</p>
