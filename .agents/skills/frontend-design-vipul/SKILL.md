---
name: frontend-design-vipul
description: Use automatically for implementation-focused frontend construction when reusable HTML/CSS/JS/React patterns or the bundled vanilla starter will materially help. Covers layout, motion, accessibility, responsiveness, and production polish. Prefer frontend-design for primary visual art direction and impeccable for audits or incremental refinement of existing UI. Do not use for backend work or browser testing.
---
