...
| NG-B02 | B02 | Lightweight owner-operated privacy/data-rights direction, opt-in push, personal self-study accounts, and pending adjustable-duration classroom-code membership requests | Dhion | Enrollment foundation implemented expand-first; privacy/legal/hosting release gates remain | `docs/decisions/NG-B02-DECISIONS.md` |
| NG-B03 | B03 | ASVS L2 target, passkey-first MFA, authentication/session/upload/logging/backup gates | Dhion | Accepted for staged implementation; production topology pending | `docs/decisions/NG-B03-DECISIONS.md` |
...
| NG-B05 | B05 | Truthful public journey, role-aware onboarding/search/help, usability study, and tenant-scoped roles with separate Content Author capability | Dhion | Tenant-role foundation implemented expand-first; broader B05 work remains; all three demo accounts remain enabled | `docs/decisions/NG-B05-DECISIONS.md` |
